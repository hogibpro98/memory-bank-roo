...
> 💡 **Tip quan trọng về UTF-8**: Luôn sử dụng encoding UTF-8 khi làm việc với database MySQL để đảm bảo comment tiếng Nhật hiển thị đúng:
> - Sử dụng `--default-character-set=utf8mb4` trong lệnh MySQL
> - Thêm `SET NAMES utf8mb4;` vào đầu query 
> - Sử dụng user `root/rootpassword` cho quyền truy cập đầy đủ
> 
> **Ví dụ**: `docker exec db mysql -u root -prootpassword kantaki_dev -e "SET NAMES utf8mb4; SELECT * FROM mst_user LIMIT 10;" --default-character-set=utf8mb4`